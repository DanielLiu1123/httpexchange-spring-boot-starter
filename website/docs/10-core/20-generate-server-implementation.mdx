...
:::tip
Starting from version 3.3.5.1, please use the `httpExchangeConfig` option to specify the configuration file path,
...
When the version >= 3.3.5.1, please use the `httpExchangeConfig` option to specify the configuration file path.
