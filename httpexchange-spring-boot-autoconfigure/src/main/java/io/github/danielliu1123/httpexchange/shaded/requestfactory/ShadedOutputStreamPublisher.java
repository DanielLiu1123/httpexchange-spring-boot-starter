 ...
 * @since 2023/12/27
 */
class ShadedOutputStreamPublisher<T> implements Flow.Publisher<T> {
    ...
    private ShadedOutputStreamPublisher(
            OutputStreamHandler outputStreamHandler, ByteMapper<T> byteMapper, Executor executor, int chunkSize) {
    ...
    public static <T> Flow.Publisher<T> create(
        ...
        return new ShadedOutputStreamPublisher<>(outputStreamHandler, byteMapper, executor, DEFAULT_CHUNK_SIZE);
    }
    ...
    public static <T> Flow.Publisher<T> create(
        ...
        return new ShadedOutputStreamPublisher<>(outputStreamHandler, byteMapper, executor, chunkSize);
    }
    ...
    public void subscribe(Flow.Subscriber<? super T> subscriber) {
        ...
        OutputStreamSubscription<T> subscription =
                new OutputStreamSubscription<>(subscriber, this.outputStreamHandler, this.byteMapper, this.chunkSize);
    ...
    private static final class OutputStreamSubscription<T> extends OutputStream implements Flow.Subscription {
        ...
        public OutputStreamSubscription(
